...
| 6 | [Abstract linear (vector) spaces](chapters/06-abstract-vector-spaces/notes.md)<br/><sub>*Polynomials, functions, matrices are all vectors — same axioms, same theorems.*</sub> | Ch. 4 · — | [open ↗](https://notebooklm.google.com/notebook/14ad0e7d-6164-4589-93d8-37777a58b05f) | [view](chapters/06-abstract-vector-spaces/code/python/06_abstract_spaces.ipynb) | [view](chapters/06-abstract-vector-spaces/code/sage/06_abstract_spaces.ipynb) |
| 7 | [Orthogonality, projections, Gram–Schmidt, QR, least squares](chapters/07-orthogonality-and-least-squares/notes.md)<br/><sub>*Orthonormal bases via Gram–Schmidt, **QR factorization** (A = QR), and least squares for overdetermined systems.*</sub> | Ch. 5 · §4.10–4.11 | [open ↗](https://notebooklm.google.com/notebook/f887b942-aaad-4eb7-b3fb-a5b3b822a23e) | [view](chapters/07-orthogonality-and-least-squares/code/python/07_orthogonality.ipynb) | [view](chapters/07-orthogonality-and-least-squares/code/sage/07_orthogonality.ipynb) |
| 8 | [Determinants — algebra and geometry](chapters/08-determinants/notes.md)<br/><sub>*Determinant as signed volume, multiplicativity, Cramer's rule — the tool that sets up eigenvalues.*</sub> | Ch. 6 · §5.5 | [open ↗](https://notebooklm.google.com/notebook/5fcb942c-66ad-4aee-a4f4-c073d428722f) | [view](chapters/08-determinants/code/python/08_determinants.ipynb) | [view](chapters/08-determinants/code/sage/08_determinants.ipynb) |
